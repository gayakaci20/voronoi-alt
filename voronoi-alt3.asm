...
dessiner:
    ...
    xor rbx, rbx
.dessiner_cibles:
    ; Couleur de la ligne en fonction de l'indice
    mov eax, ebx
    xor edx, edx
    mov ecx, 10
    div ecx
    mov eax, dword[palette_couleurs + edx*4]
    
    ; Définir la couleur du contexte graphique
    mov rdi, qword[ecran_nom]
    mov rsi, qword[contexte]
    mov edx, eax
    call XSetForeground
    
    ; Dessin du point de la cible
    mov rdi, qword[ecran_nom]
    mov rsi, qword[fenetre]
    ...
    ; Couleur rouge pour les centres
    mov rdi, qword[ecran_nom]
    mov rsi, qword[contexte]
    mov edx, 0xFF0000
    call XSetForeground
